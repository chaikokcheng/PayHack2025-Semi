...
function BankStatementUploadStep({ route, navigation }) {
  ...
  const handleNext = () => {
    ...
    navigation.navigate('BankStatementSummaryStep', { file, onComplete: route.params?.onComplete });
  };
  ...
  return (
    <View style={styles.root}>
      ...
      <Text style={styles.subtitle}>Upload a PDF or image of your recent bank statement.</Text>
...
export default BankStatementUploadStep; 